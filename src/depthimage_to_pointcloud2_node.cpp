...
#include "tracker_msgs/msg/rgb_depth.hpp"
#include "tracker_msgs/msg/rgb_pc2.hpp"
...
public:
    ...
    : Node("depthimage_to_pointcloud2_node", options)
    {
      ...
      g_pub_point_cloud = this->create_publisher<tracker_msgs::msg::RgbPc2>("rgb_pointcloud2", 10);
      ...
      depthimage_sub = this->create_subscription<tracker_msgs::msg::RgbDepth>(
...
private:
    void depthCb(const tracker_msgs::msg::RgbDepth::SharedPtr msg)
    {
      ...
      tracker_msgs::msg::RgbPc2 rgb_pc2;
      rgb_pc2.rgb = msg->rgb;
      rgb_pc2.pc2 = *cloud_msg;

      g_pub_point_cloud->publish(rgb_pc2);
    }
    ...
    rclcpp::Publisher<tracker_msgs::msg::RgbPc2>::SharedPtr g_pub_point_cloud;
    rclcpp::Subscription<tracker_msgs::msg::RgbDepth>::SharedPtr depthimage_sub;
